...
```bash
sudo apt install ./moraine_0.3.0-1_amd64.deb
```
...
```bash
sudo pacman -U https://github.com/TheJonaz/moraine-backup/releases/download/v0.3.0/moraine-0.3.0-1-x86_64.pkg.tar.zst
```
